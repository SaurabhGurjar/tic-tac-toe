    ...
    const gameboard = () => {
        ...
        <div class="main">
            ...
            <div class="player-info">
                <h3 class="player-marker" id="player-1">Player 1: X</h3>
                <button id="play-again" type="button">Play Again</button>
                <h3 class="player-marker" id="player-2">Player 2: O</h3>
            </div>
        </div>`;
    };
...
window.addEventListener('DOMContentLoaded', render.gameboard);
